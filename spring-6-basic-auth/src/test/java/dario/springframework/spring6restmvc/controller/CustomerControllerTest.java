package dario.springframework.spring6restmvc.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import dario.springframework.spring6restmvc.config.SpringSecConfig;
...
class CustomerControllerTest {
    ...
    void getCustomerByIdNotFound() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.CUSTOMER_PATH_ID, UUID.randomUUID()).with(httpBasic("dario", "password")))
